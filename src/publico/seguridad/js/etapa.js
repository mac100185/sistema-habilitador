$('#testEtapa').click(function () {
    ...
    fetch(host + "/api/seguridad_def/habilitadores/etapa/cumplimiento/" + iniciativa)
        .then(function (response) {
            return response.text();
        })
        .then(function (data) {
    ...
    let titulo2 = [
        {
            "Id": "1",
            "Titulo": "(1) Aplica si existe integración con terceros y salida de información en la iniciativa "
    },
        {
            "Id": "2",
            "Titulo": "(2) Aplica si existe un componente de autenticación en la iniciativa "
    },
        {
            "Id": 3,
        ...
        {
            "Id": 7,
            "Titulo": "(7) Aplica si algún miembro del squad tiene  rol Admin sobre algún portal expuesto en internet "
    },
        {
            "Id": 8,
            "Titulo": "(8) Aplica si la aplicación tiene componente de login estándar o propio "
    },
        {
            "Id": 9,
        ...
        {
            "Id": 13,
            "Titulo": "(13) Aplica  cuando se aplica los controles de seguridad dell Trike "
    },
        {
            "Id": 14,
