    ...
    $.extend($.summernote.plugins, {
        ...
        'add-text-tags': function (context) {
            ...
            self.generateBtn = function (tag, tooltip) {
                ...
                return ui.button({
                    contents: '<' + tag + ' class="test" >' + char + '</' + tag + '>',
                    tooltip: tooltip + ' <' + tag + ' class="ko">',
                ...
                if (window.getSelection) {
                    ...
                    if (selected.startOffset !== selected.endOffset) {
                       ...
                       var newNode = document.createElement(tag);                       
                        ...
                        //var newNode = '<pre class="command-line language-bash" data-user="user" data-host="Kali"><code>test</code></pre>';
