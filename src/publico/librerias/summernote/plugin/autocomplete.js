//https://socket.dev/npm/package/summernote-handlebars-autocomplete
        ...
        (function (factory) {
            ...
            $.extend($.summernote.plugins, {
                handlebarsAutocomplete: function handlebarsAutocomplete(context) {
                   ...
                   // Colores
                    this.hoverColor = '#AD5D4E';
                    this.backgroundColor = '#3e424a';
                    this.fontSize = '12px';
                ...
                //Llave Segundo
                 pentestAutocomplete: function pentestAutocomplete(context) {
                    var _this = this;
                   ...
                   // Colores
                     ...
                     * Read-in options. *
                     ********************/
                    if (context.options && context.options && context.options.pentestAutocomplete) {
                        var summernoteOptions = context.options.pentestAutocomplete;
